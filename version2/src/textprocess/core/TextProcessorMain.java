 ...
 *  
 * 					:REDESIGNED PARALLEL TEXT-FILTER:
 * Multiple instances of whichever text-filter is directly facing the data-source
 * are created, to improve the response-time of the overall program by
 * increasing the number of queue-pulls occurring on the outgoing pipe of
 * the Data Source.
 *  
